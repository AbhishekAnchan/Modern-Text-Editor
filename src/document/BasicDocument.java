...
public class BasicDocument extends Document {
	...
	public static void main(String[] args) {
		...
		testCase(new BasicDocument("This is a test.  How many???  "
				...
				16, 13, 5, 100.0729);
		testCase(new BasicDocument(""), 0, 0, 0, 0.0);
		testCase(new BasicDocument("sentence, with, lots, of, commas.!  "
		        + "(And some poaren)).  The output is: 7.5."), 15, 11, 4, 88.6801);
		testCase(new BasicDocument("many???  Senteeeeeeeeeences are"), 6, 3, 2, 36.1125);
		testCase(new BasicDocument("Here is a series of test sentences. Your program should "
				+ "find 3 sentences, 33 words, and 49 syllables. Not every word will have "
				+ "the correct amount of syllables (example, for example), "
				+ "but most of them will."), 49, 33, 3, 70.0518);
		testCase(new BasicDocument("Segue"), 2, 1, 1, 36.62);
		testCase(new BasicDocument("Sentence"), 2, 1, 1, 36.62);
		testCase(new BasicDocument("Sentences?!"), 3, 1, 1, -47.98);
